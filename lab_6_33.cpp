...
// Метод Зейделя
void ZeidelIteration(const std::vector<std::vector<double>>& A, const std::vector<double>& b, double tol = 1e-6, int maxIter = 1000) {
    int n = A.size();
    ...
    std::cout << "=== Решение методом простых итераций (Зейдель) ===\n";
...
int main() {
    ...
    std::vector<double> b = {-1.24, 0.91, 2.56, -0.88, 0.1};
